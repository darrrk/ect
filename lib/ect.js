/*!
 * ECT CoffeeScript template engine v0.5.10
...
(function () {
	...
	var	ECT = function (options) {
		...
		TemplateContext.prototype.load = function (template) {
			...
			if (ect.options.cache && ect.cache[template]) {
				return ect.cache[template];
			} else {
